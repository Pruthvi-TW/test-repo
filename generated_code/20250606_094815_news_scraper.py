...
class NewsScraper:
    ...
    def fetch_page(self) -> str:
        ...
        try:
            ...
            raise NewsScraperError(f"Failed to fetch page: {str(e)}")
    ...
    def save_to_json(self, articles: List[Dict[str, str]], filename: str) -> None:
        ...
        try:
            ...
            raise NewsScraperError(f"Failed to save JSON file: {str(e)}")
...
def main():
    ...
    # Example usage
    news_url = "https://example-news-site.com"  # Replace with actual news website URL
    scraper = NewsScraper(news_url)
    scraper.run("scraped_articles.json")
