...
class AgenticWorkflow:
    ...
    def _create_workflow(self) -> StateGraph:
        ...
        workflow.add_node("prevalidation", self._prevalidation_node)
        workflow.add_node("business_context", self._business_context_node)
        workflow.add_node("code_generation", self._code_generation_node)
        workflow.add_node("code_evaluation", self._code_evaluation_node)
        workflow.add_node("dependency_evaluation", self._dependency_evaluation_node)
        workflow.add_node("guardrails", self._guardrails_node)
        workflow.add_node("code_push", self._code_push_node)
        
        # Define the workflow edges
        workflow.set_entry_point("prevalidation")
        ...
        workflow.add_conditional_edges(
            ...
            {
                "continue": "dependency_evaluation",
                "stop": END
            }
        )
        ...
        workflow.add_edge("code_push", END)
